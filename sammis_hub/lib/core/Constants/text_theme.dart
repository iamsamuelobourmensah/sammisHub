...
class TextTheming {
 ...
 static final TextTheme darkTextTheme = TextTheme(
   ...
   displayLarge: const TextStyle().copyWith(fontSize: 42,  color: Colortheme.labelTertiary),
    displayMedium: const TextStyle().copyWith(fontSize: 32,  color: Colortheme.labelTertiary),
    displaySmall: const TextStyle().copyWith(fontSize: 24, color: Colortheme.labelTertiary),
    ...
    // bodyMedium: const TextStyle().copyWith(fontSize: 24, fontWeight: FontWeight.w500, color: Colors.white),
      bodySmall: const TextStyle().copyWith(fontSize: 18, color: Colortheme.labelTertiary),
...
//     titleSmall: const TextStyle().copyWith(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.black87),// for small text but bold
    ...
    displayLarge: const TextStyle().copyWith(fontSize: 42,color:Colortheme.labelPrimary),
    displayMedium: const TextStyle().copyWith(fontSize: 32, color: Colortheme.labelPrimary),
   displaySmall: const TextStyle().copyWith(fontSize: 24,color: Colortheme.labelPrimary),
...
//      bodyMedium: const TextStyle().copyWith(fontSize: 17, fontWeight: FontWeight.bold, color: Colors.black87),// for large but bold font
     bodySmall: const TextStyle().copyWith(fontSize: 18,color: Colortheme.labelPrimary), 
